...
/* harmony import */ var _modules_modals_mask_phone__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modals/mask-phone */ "./js/modules/modals/mask-phone.js");
/* harmony import */ var _modules_modals_popap_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modals/popap-form */ "./js/modules/modals/popap-form.js");
/* harmony import */ var _modules_modals_popap_form__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_modals_popap_form__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _modules_modals_about_company__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modals/about-company */ "./js/modules/modals/about-company.js");
/* harmony import */ var _modules_modals_about_company__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_modals_about_company__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _modules_modals_scroll__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/modals/scroll */ "./js/modules/modals/scroll.js");
/* harmony import */ var _modules_modals_scroll__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_modals_scroll__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _modules_modals_accordeon__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/modals/accordeon */ "./js/modules/modals/accordeon.js");
/* harmony import */ var _modules_modals_accordeon__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_modals_accordeon__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _modules_modals_form__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/modals/form */ "./js/modules/modals/form.js");
/* harmony import */ var _modules_modals_form__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_modules_modals_form__WEBPACK_IMPORTED_MODULE_7__);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  Object(_modules_modals_mask_phone__WEBPACK_IMPORTED_MODULE_2__["maskPhone"])();
...
/***/ "./js/modules/modals/about-company.js":
/*!********************************************!*\
  !*** ./js/modules/modals/about-company.js ***!
  \********************************************/
...
var aboutButton = document.querySelector('.about-company__button');
...
/***/ "./js/modules/modals/accordeon.js":
/*!****************************************!*\
  !*** ./js/modules/modals/accordeon.js ***!
  \****************************************/
/*! no static exports found */
...
document.querySelectorAll('.accordeon').forEach(function (accordeon) {
  accordeon.addEventListener('click', function () {
    if (accordeon.classList.contains('accordeon--open')) {
      ...
      document.querySelectorAll('.accordeon').forEach(function (accordeonItem) {
        return accordeonItem.classList.remove('accordeon--open');
      });
...
var inputFields = document.querySelectorAll('input:not(input[type="checkbox"])');
...
/***/ "./js/modules/modals/mask-phone.js":
/*!*****************************************!*\
  !*** ./js/modules/modals/mask-phone.js ***!
  \*****************************************/
...
var phoneFields = document.querySelectorAll('#modal-phone, #client-phone-pop-up');
var PHONE_TEMPLATE_START = '+7(';
var PHONE_TEMPLATE_MIDDLE = ')';
var isPhoneBeingWritten = false;
var maskPhone = function maskPhone() {
  if (phoneFields.length > 0) {
    var _iterator = _createForOfIteratorHelper(phoneFields),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        field.addEventListener('input', function (evt) {
          var userValue = evt.target.value;
          var regexp = /[^+?^\(?\)?\d?]/;
...
/***/ "./js/modules/modals/popap-form.js":
/*!*****************************************!*\
  !*** ./js/modules/modals/popap-form.js ***!
  \*****************************************/
/*! no static exports found */
...
var orderButton = document.querySelector('.main-nav__toggle');
var modalCall = document.querySelector('.popap-form');
var pageBody = document.getElementsByTagName('body');
var buttonCloseModal = document.querySelector('.popap-form__button-close');
var nameInput = document.querySelector('#name-call');
var approvalInput = document.querySelector('#personal-call');
var inputFirst = document.querySelector('#popap-form');
var inputLast = document.querySelector('#popap-form-last');
if (modalCall) {
  ...
  inputLast.addEventListener('focus', function () {
    buttonCloseModal.focus();
  });
  inputFirst.addEventListener('focus', function () {
    approvalInput.focus();
  });
}
...
var formFeedback = document.getElementById('form-section');
var btn = document.querySelector('.promo__button');
