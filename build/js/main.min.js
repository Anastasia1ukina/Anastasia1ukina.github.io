...
var popapForm = document.querySelector('.popap-form');
var pageBody = document.querySelector('body');
var buttonClosePopap = document.querySelector('.popap-form__button-close');
...
if (popapForm) {
  ...
  buttonClosePopap.addEventListener('click', function () {
    popapForm.classList.toggle('popap-form--open');
    pageBody.classList.toggle('body--opened-modal');
  });
  ...
  popapForm.addEventListener('click', function (evt) {
    var target = evt.target;
