...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new inputmask__WEBPACK_IMPORTED_MODULE_2___default.a({
...
var approvalInput = document.querySelector('#approval-call');
var inputFirst = document.querySelector('#modal-input-first');
var inputLast = document.querySelector('#modal-input-last');
if (popupForm) {
